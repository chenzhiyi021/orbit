...
# 300-step "hard SFT" TRL SFTConfig-style YAML (accelerate + deepspeed_zero3,
...
# === Recipe identity ===
LAUNCHER_NAME=${LAUNCHER_NAME:-unified_m1_sft_hard_non_thinking_300step}
...
SAVE_DIR="${SAVE_DIR:-${ORBIT_ROOT}/orbit_ckpts/unified-m1-sft-hard-non-thinking-300step}"
