...
# full-vocabulary on-policy distillation, pure forward KL(teacher||student)
# (--opd-jsd-beta 0.0). Self-contained launcher.
#
...
# === Recipe identity ===
LAUNCHER_NAME=run_qwen3_17b_bf16_openreasoning_opd_full_vocab_fullft_fkl
...
SAVE_DIR="${SAVE_DIR:-${ORBIT_ROOT}/orbit_ckpts/Qwen3-1.7B_4B_openreasoning_full_vocab_opd_fullft_fkl}"
...
# Full-vocab OPD, pure forward KL(teacher||student): opd-jsd-beta=0.0. See header
